...
GPA: 4.0+/4.0
\item {\bf Columbia University - New York, NY} \hfill {\em Sep 2020 - Feb 2022}\\
...
\begin{itemize}
\item {\bf Outstanding Teaching Assistant} \hfill {\em June 2026}
\item {\bf INFORMS TSL Data-Driven Research Challenge - Finalist} \hfill {\em May 2025}
...
\begin{itemize}
\item {\bf Optimal Batched Scheduling of Stochastic Processing Networks Using Atomic Action Decomposition}\hfill {\em (Major Revision at Management Science; Revision Submitted)}\\
Jim Dai, Manxi Wu, \underline{Zhanhao Zhang}*.
\item {\bf Atomic proximal policy optimization for electric robo-taxi dispatch and charger allocation}\hfill {\em (Minor Revision at Transportation Science)}\\
Jim Dai, Manxi Wu, \underline{Zhanhao Zhang}*.
\item {\bf Deep Learning Method for Stationary Distribution of Reflected Brownian Motion} \hfill {\em (Submitted to Stochastic Systems)}\\
Jim Dai, \underline{Zhanhao Zhang}*.
\item {\bf Mixed-Type Courier Dispatch For Online Food Delivery Platforms}\hfill {\em (Major Revision at Transportation Science; Revision Submitted)}\\
Junlin Chen*, Manxi Wu, Chiwei Yan, \underline{Zhanhao Zhang}*.
\item {\bf Designing high-occupancy toll lanes: A game-theoretic analysis}\hfill {\em (Major Revision at Transportation Science)}\\
\underline{Zhanhao Zhang}*, Ruifan Yang*, Manxi Wu.
\item {\bf Generative Market Equilibrium Models with Stable Adversarial Learning via Reinforcement Link}\hfill {\em (Major Revision at SIAM Journal on Financial Mathematics; Revision Submitted)}\\
Anastasis Kratsios, Xiaofei Shi, Qiang Sun, \underline{Zhanhao Zhang}*.
%\item {\bf Efficient Computation of Gromov-Wasserstein Alignment via a Sparse Frank-Wolfe Method}\hfill {\em In progress}\\
%\underline{Zhanhao Zhang}*, Qing Feng*, Soroosh Shafiee, Ziv Goldfeld.
\end{itemize}
\end{rSection}
...
\begin{itemize}
\item {\bf 2026 INFOMRS Annual Meeting}\hfill {\em Nov 2026}\\
San Francisco, California, USA
\item {\bf 2025 INFOMRS Annual Meeting}\hfill {\em Oct 2025}\\
Atlanta, Georgia, USA
\item {\bf International Transportation Economics Association (ITEA) 2025}\hfill {\em Jun 2025}\\
...
\begin{itemize}
\item {\bf Rising Star Workshop 2026}\hfill {\em March 2026}\\
...
\begin{itemize}
\item {\bf Research Intern, Machine Learning (PhD)}\hfill {\em May 2026 - Aug 2026}\\
Meta, Seattle, WA
\item {\bf Research Intern, Mapping}\hfill {\em Jun 2025 - Aug 2025}\\
Akamai, Boston, MA
...
\begin{itemize}
	...
	\begin{itemize}
		\item Spring 2024 \& Spring 2025 \& Spring 2026: {\em Big Data Technologies}
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	\item Operations Research \& Information Engineering, Cornell University
	\begin{itemize}
		\item Fall 2025 \& Fall 2026: {\em Reinforcement Learning with Operations Research Applications}
