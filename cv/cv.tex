...
Jim Dai, Manxi Wu, \underline{Zhanhao Zhang}*.
\item {\bf Generative Market Equilibrium Models with Stable Adversarial Learning via Reinforcement Link}\hfill {\em (Submitted to SIAM Journal on Financial Mathematics)}\\
